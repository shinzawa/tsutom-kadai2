    ...
    <div class="product-main">
        <div class="product-oparation">
            <form action="/products/search" method="get" class="search-form" novalidate>
                @csrf
                <input class="search-form__name-input" type="text" name="name" value="{{ old('name')}}" placeholder="商品名で検索">
            ...
            <form class="sort-form" action="/products/search" method="get" novalidate>
                ...
                <div class="sort-form__price-order">
                    <select class="sort-form__order-select" name="order" value="{{ old('order')}}" onchange="handleSelectChange(this)">
